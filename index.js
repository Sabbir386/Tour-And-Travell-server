...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASSWORD}@cluster0.z2phr5m.mongodb.net/Travell-Buddy?retryWrites=true&w=majority&appName=Cluster0`;
